...
| ~~B4~~ | ~~Kontaminasyon tartışması~~ **KAPANDI (2026-08-13):** `docs/kontaminasyon-b4.md` — 6 kanıt hattı + 2 yeni sonda: model 620'yi hatırlamıyor (S1) ve 64k thinking'le bile artefaktı doğrudan üretemiyor (S2, sıfır blok) — yetenek retrieval'da değil, muhakeme→kod→yürütme hattında. | — | — |
